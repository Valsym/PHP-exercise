...
Задание
x
Для формирования ответа очень часто используют специальный Response Builder, который накапливает в себе данные, которые должны быть отправлены клиенту. Это такие данные, как статус, различные заголовки и тело ответа.
